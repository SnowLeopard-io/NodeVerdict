...
export function App() {
  const { currentPage, language } = useUIStore();
  const darkMode = useUIStore((s) => s.darkMode);

  // Apply theme and language attributes from the store so the UI stays in sync
  // across initial render, navigation, and preference changes.
  useEffect(() => {
